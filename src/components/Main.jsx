...
const productsData = [
  {
    ...
    description:
      "Water purifier cha hatua 8 kisichotumia umeme kusafisha maji ya manispaa. Mimina maji juu na upate maji safi na yenye afya kwenye tundu la kutolea. Hutoa takribani lita 30 kwa siku, chenye uwezo wa jumla wa lita 14 na nafasi ya kuhifadhi lita 9 za maji yaliyotibiwa.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Dayliff Mini RO, pia hujulikana kama Undersink RO, ni mfumo unaoweza kufungwa kwa urahisi chini ya sinki la kawaida nyumbani. Unatumia teknolojia ya reverse osmosis kuzalisha maji safi kabisa kutoka kwenye maji ya kisima au maji ya bomba la manispaa/jiji.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Mashine ya kusafisha maji ya bomba au maji ya kisima kwa teknolojia ya Reverse Osmosis, kinachofaa kufungwa chini ya sinki. Muundo wake usio na tanki unahitaji nafasi ndogo na hutoa maji ya RO pamoja na maji yaliyotibiwa kabla.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Dispenser ya kusafisha maji ya bomba bila kutumia umeme. Mimina maji juu na upate maji safi na salama kwenye tundu la kutolea. Hutoa takribani lita 30 kwa siku, chenye jumla ujazo wa lita 14 na nafasi ya kuhifadhi lita 9 za maji yaliyotibiwa.",
    specs: [
